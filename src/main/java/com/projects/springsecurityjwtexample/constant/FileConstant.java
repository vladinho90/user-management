package com.projects.springsecurityjwtexample.constant;
...
public class FileConstant {
    ...
    public static final String DIRECTORY_CREATED = "Created directory for: ";    public static final String DEFAULT_USER_IMAGE_PATH = "/user/image/profile/";
